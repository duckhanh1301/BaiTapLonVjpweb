...
import OwnerOperationsPage from "./page/OwnerOperationsPage";
import Layout from "./components/Layout";
import { getCurrentUser } from "./services/authService";
import "bootstrap/dist/css/bootstrap.min.css";

const OwnerRoute = ({ children }) => (
  <PrivateRoute allowedRoles={["ChuThue"]}>{children}</PrivateRoute>
);
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          {/* User Routes */}
                    <Route path="/operations" element={<OwnerRoute><OwnerOperationsPage /></OwnerRoute>} />
                    <Route
                        path="/my-contracts"
            element={
              <UserRoute>
